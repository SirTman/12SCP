...
//=============================================================================
 /*:
 * @plugindesc v1.0.1 Enables events to be pushed around on the map for making puzzles!
 * @author Terrax
 *
 *
 * @help
 ...
 *
 *
 * For compatiblity with the terrax lighting system,
 * make sure the puzzle plugin is above the lighting plugin in the list
